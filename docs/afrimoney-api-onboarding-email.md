# AfriMoney API Onboarding Email (Ready To Send)

Subject: AfriMoney API Onboarding Request - Collections and Winner Payouts (Sandbox + Production)

Hello AfriMoney Integration Team,

We are integrating AfriMoney mobile money into our betting platform and need onboarding details for both:
