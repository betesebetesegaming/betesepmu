...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "deposit_step_1": "Send money via Wave to our official number.",
    "deposit_step_2": "Enter the Sender Phone Number you used for the payment below.",
    "deposit_step_3": "Fill the form and submit. Your wallet will be credited once verified.",
  ...
  fr: {
    ...
    "deposit_step_1": "Envoyez de l'argent via Wave à notre numéro officiel.",
    "deposit_step_2": "Entrez le numéro de téléphone de l'expéditeur ci-dessous.",
    "deposit_step_3": "Remplissez le formulaire. Votre compte sera crédité après vérification.",
